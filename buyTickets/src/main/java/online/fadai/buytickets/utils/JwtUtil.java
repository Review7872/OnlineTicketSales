package online.fadai.buytickets.utils;
...
public class JwtUtil {
    ...
    private final static String secret = "031027";

    //jwt签发者
    private final static String jwt_iss = "fadai";
     ...
     */
    public static String generateJwtToken(String username, String auth) {
